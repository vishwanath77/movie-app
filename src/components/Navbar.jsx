      ...
      <header className="w-full mx-auto flex flex-wrap items-center justify-between p-3 px-16 h-5">
        ...
        <div className="flex gap-5 items-center z-50">
          ...
          <Link
              to="/admin"
            >
              <FontAwesomeIcon icon={faUser} className="text-white-500 text-xl" />
            </Link>
        ...
        {isMobileMenuOpen && (
          <div className="w-full sm:hidden mt-4 z-50 bg-black border rounded border-gray-800">
            <Link
              to="/"
              className="block hover:text-white/60 transition-colors duration-500"
              onClick={() => setContentType('movie')}
            >
              Movies
            </Link>
            ...
            {/* <Link
              to="/admin"
              className="block hover:text-white/60 transition-colors duration-500 text-white-500"
            >
              Admin
            </Link> */}
          </div>
